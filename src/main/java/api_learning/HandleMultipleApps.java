...
public class HandleMultipleApps {
    public static void main(String[] args){
        ...
        try{
            ...
            MobileElement wifiButton = appiumDriver.findElement(MobileBy.xpath("//android.widget.TextView[@resource-id=\"android:id/title\" and @text=\"Kết nối\"]"));
            wifiButton.click();
            Thread.sleep(3000);

            appiumDriver.activateApp("com.wdiodemoapp");
            MobileElement okButton_2 = appiumDriver.findElement(MobileBy.xpath("//android.widget.TextView[@text=\"LOGIN\"]"));
            okButton_2.click();
            Thread.sleep(3000);
